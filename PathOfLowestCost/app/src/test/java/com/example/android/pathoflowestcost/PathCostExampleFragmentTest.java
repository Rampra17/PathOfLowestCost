 ...
 */
public class PathCostExampleFragmentTest {

    private PathCostExampleFragment fragment;

    @Before
    public void setUp() {
        fragment = new PathCostExampleFragment();
    ...
    public void clickingExampleOneButtonLoadsExampleGridOne() {
        String expectedContents = UtilsOfGrid.EXAMPLE_GRID_1.asDelimitedString("\t");
    ...
    public void clickingExampleTwoButtonLoadsExampleGridTwo() {
        String expectedContents = UtilsOfGrid.EXAMPLE_GRID_2.asDelimitedString("\t");
    ...
    public void clickingExampleThreeButtonLoadsExampleGridThree() {
        String expectedContents = UtilsOfGrid.EXAMPLE_GRID_3.asDelimitedString("\t");
